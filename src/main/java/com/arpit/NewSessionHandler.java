...
public class NewSessionHandler extends TextWebSocketHandler {
    ...
    public void setConnection() {
        ...
        Map<String,Integer> alternate = hzInstance.getMap("alternate");
        alternate.put("key",1);
    }
        ...
        try {
            ...
            if (key == 1) {
                ...
                for(Map.Entry entry : alternate.entrySet())
                {
                    ...
                    {
                        alternate.put(entry.getKey().toString(),session.getId());
                ...
                String value = alternate.get(session.getId());
